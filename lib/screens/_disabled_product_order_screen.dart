...
class ProductOrderScreenState extends State<ProductOrderScreen> {
  ...
  void addToCartDirectly(Map<String, dynamic> item) {
    addToCart(item, 1);
    if (mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
  ...
  void toggleFavorite(String itemCode) {
  ...
  void toggleTradeFavorite(String tradeCode) {
  ...
  List<Map<String, dynamic>> getFilteredTrades() {
  ...
  void toggleMultiSelect(String itemCode) {
    setState(() {
                            ...
                            Container(
                              ...
                              child: Scrollbar(
                                child: SingleChildScrollView(
                                  child: Column(
                                    children: getFilteredTrades().map((trade) {
                                      ...
                                      return Container(
                                        ...
                                        child: ListTile(
                                          leading: IconButton(
                                            ...
                                            onPressed: () => toggleTradeFavorite(trade['TR_CD']),
                                          ),
                                          title: Text(
                                            '${trade['TR_NM']}',
              ...
              child: ListTile(
                leading: _isMultiSelectMode
                    ? Checkbox(
                        value: isSelected,
                        onChanged: (value) {
                          toggleMultiSelect(item['ERPCODE']);
                        },
                      )
                    : null,
                title: Text(item['품명'] ?? '품명 없음'),
                ...
                trailing: Row(
                  ...
                  children: [
                    IconButton(
                      ...
                      onPressed: () => toggleFavorite(item['ERPCODE']),
                    ),
                    Container(
                      decoration: BoxDecoration(
                        color: Colors.green,
